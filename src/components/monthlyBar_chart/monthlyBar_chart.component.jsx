...
const MonthlyBarChart = () => {
  ...
  const Chart = () => {
    ...
    const janReviewing = jan.filter((item) => item.status_title == "Reviewing");
    ...
    const febReviewing = feb.filter((item) => item.status_title == "Reviewing");
    ...
    const marchClosed = march.filter((item) => item.status_title == "Closed");

    const aprOpen = apr.filter((item) => item.status_title == "Open");
    const aprInProgress = apr.filter(
      (item) => item.status_title == "In Progress"
    );
    const aprReviewing = apr.filter((item) => item.status_title == "Reviewing");
    ...
    const mayReviewing = may.filter((item) => item.status_title == "Reviewing");
    ...
    const junReviewing = jun.filter((item) => item.status_title == "Reviewing");
    ...
    const augReviewing = aug.filter((item) => item.status_title == "Reviewing");
    ...
    const sepReviewing = sep.filter((item) => item.status_title == "Reviewing");
    ...
    const octReviewing = oct.filter((item) => item.status_title == "Reviewing");
    ...
    const novReviewing = nov.filter((item) => item.status_title == "Reviewing");
    ...
    const decReviewing = dec.filter((item) => item.status_title == "Reviewing");
